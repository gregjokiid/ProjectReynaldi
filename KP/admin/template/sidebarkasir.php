          ...
          <div id="sidebar"  class="nav-collapse">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="index.php?page=barangkasir">Barang</a></li>
                          <li><a  href="index.php?page=kategorikasir">Kategori</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a  href="index.php?page=laporanak">Laporan Penjualan</a></li>
                      </ul>
                  </li>
                  <!-- <li class="sub-menu">
                      <a href="javascript:;" >
