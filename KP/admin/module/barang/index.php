							...
							<table class="table table-bordered table-striped" id="example1">
								...
								?>
									<tr>
										...
										<td>
											<?php if($isi['stok'] <=  '1'){?>
												<form method="POST" action="fungsi/edit/edit.php?restok=edit">
													<input type="number" min="1" name="restok" class="form-control">
											...
											<a href="index.php?page=barang/tambah&barang=<?php echo $isi['id_barang'];?>"><button class="btn btn-success btn-xs">Tambah Stok</button></a>
								...
								<form action="fungsi/tambah/tambah.php?barang=tambah" method="POST">
									<div class="modal-body">
										...
										<table class="table table-striped bordered">
											...
											<tr>
												<td>Harga Beli</td>
												<td><input type="number" placeholder="Harga beli" min="1" required class="form-control" name="beli"></td>
											</tr>
											<tr>
												<td>Harga Jual</td>
												<td><input type="number" placeholder="Harga Jual" min="1" required class="form-control"  name="jual"></td>
											</tr>
											<tr>
												<td>Satuan Barang</td>
												<td>
											...
											<tr>
												<td>Stok</td>
												<td><input type="number" required Placeholder="Stok" min="1" class="form-control"  name="stok"></td>																						
											</tr>
											<tr>
												<td>Tanggal Input</td>
