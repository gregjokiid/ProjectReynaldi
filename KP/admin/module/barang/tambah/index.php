                  ...
                  <div class="col-lg-12 main-chart">
						...
						<table class="table table-striped">
							<form action="fungsi/edit/edit.php?stok=edit" method="POST">
								...
								<tr>
									<td>Nama Barang</td>
									<td><input type="text" readonly="readonly" class="form-control" value="<?php echo $hasil['nama_barang'];?>" name="nama"></td>
								</tr>
								<!-- <tr>
									<td>Harga Beli</td>
									<td><input type="number" readonly="readonly" class="form-control" value="<?php echo $hasil['harga_beli'];?>" name="beli"></td>
								</tr>
								<tr>
									<td>Harga Jual</td>
								...
								<tr>
									...
									</td>                value="<?php echo $hasil['stok'];?>"
								</tr> -->
								<tr>
									<td>Stok</td>
									<td><input type="number" min="1" class="form-control" name="restok"></td>
									<!-- <input type="hidden" name="id" value="<?php echo $isi['id_barang'];?>" class="form-control"></td> -->
								</tr>
								<tr>
