 							...
 							<div id="keranjang">
 								<table class="table table-bordered">
 									...
 									<tr>
 										...
 										<!-- <td><b>ID NOTA</b></td> -->
 										<!-- <td><input type="hidden" readonly="readonly" required value="<?php echo $format; ?>" class="form-control"  name="id_nota"></td> -->
 									</tr>
 								</table>
 											...
 											<tr>
												...
												<td><input type="text" readonly="readonly" required value="<?php echo $format; ?>" class="form-control"  name="id"></td> -->
 													...
 													<form method="POST" action="fungsi/edit/edit.php?jual=jual">
 														...
 														<input type="hidden" required value="<?php echo $isi[$format]; ?>" class="form-control" name="id_nota">
 									...
 									<table class="table table-stripped">
												...
												if (!empty($bayar)) {
													...
													if ($bayar >= $total) {
														...
														for ($x = 0; $x < $jumlah_dipilih; $x++) {
															...
															$d = array($id_nota, $id_barang[$x], $id_member[$x], $jumlah[$x], $total[$x], $tgl_input[$x], $periode[$x]);
															$sql = "INSERT INTO nota (id_nota,id_barang,id_member,jumlah,total,tanggal_input,periode) VALUES(?,?,?,?,?,?,?)";

															// echo $id_nota, $id_barang, $id_member, $jumlah, $total, $tgl_input, $periode;
 										...
 										<tr>
 											...
 											<td>
 												...
 												<a href="print.php?nm_member=<?php echo $isi['nm_member']; ?>
													&bayar=<?php echo $bayar; ?>&kembali=<?php echo $hitung; ?>" target="_blank">
 													<button class="btn btn-default" href="fungsi/hapus/hapus.php?penjualan=jual">
