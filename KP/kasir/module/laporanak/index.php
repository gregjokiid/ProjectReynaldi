          ...
          <section class="wrapper">
              ...
              <div class="row">
                  <div class="col-lg-12 main-chart">
						...
						<form method="post" action="index.php?page=laporanak&cari=ok">
							<table class="table table-striped">
								...
								<td>
									...
									<a href="index.php?page=laporanak" class="btn btn-success">
									...
									<?php }?>
									<?php if(!empty($_GET['cari'])){?>
										<a href="pdf.php?cari=yes&bln=<?=$_POST['bln'];?>&thn=<?=$_POST['thn'];?>" class="btn btn-info"><i class="fa fa-download"></i>
										PDF</a>
									<?php }else{?>
										<a href="pdf.php" class="btn btn-info"><i class="fa fa-download"></i>
										PDF</a>
									<?php }?> -->
								</td>
								</tr>
						...
						<form method="post" action="index.php?page=laporanak&hari=cek">
							<table class="table table-striped">
								<tr>
									<th>
										Pilih Hari
								...
								<td>
									...
									<?php }?>
									<?php if(!empty($_GET['hari'])){?>
										<a href="pdf.php?hari=cek&tgl=<?= $_POST['hari'];?>" class="btn btn-info"><i class="fa fa-download"></i>
										pdf</a>
									<?php }else{?>
										<a href="pdf.php" class="btn btn-info"><i class="fa fa-download"></i>
										pdf</a>
